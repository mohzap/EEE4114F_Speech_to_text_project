...
dlmwrite('Valdata.csv',output_data(1,:),'delimiter',',');
dlmwrite('Valdata.csv',output_data,'delimiter',',','-append');
%dlmwrite('targetdata.csv',target_data,'delimiter',',','-append');
dlmwrite('Valtargetdata.csv',output_target_data,'delimiter',',');
dlmwrite('Valtargetdata.csv',output_target_data,'delimiter',',','-append');