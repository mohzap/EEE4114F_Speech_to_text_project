...
dlmwrite('Testdata.csv',output_data(1,:),'delimiter',',');
dlmwrite('Testdata.csv',output_data,'delimiter',',','-append');
%dlmwrite('targetdata.csv',target_data,'delimiter',',','-append');
dlmwrite('Testtargetdata.csv',output_target_data,'delimiter',',');
dlmwrite('Testtargetdata.csv',output_target_data,'delimiter',',','-append');